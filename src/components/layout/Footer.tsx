      ...
      <div className="container mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-sky-600 text-white shadow-sm">
                <HeartHandshake className="h-4.5 w-4.5" strokeWidth={1.75} />
              </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              <li className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 text-sky-600 shrink-0 mt-0.5" strokeWidth={1.75} />
                <span>28 Thành Thái, Phường 12, Quận 10, TP. Hồ Chí Minh</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="w-3.5 h-3.5 text-sky-600 shrink-0" strokeWidth={1.75} />
                <span>Hotline: 1900 2805 (8:00 - 18:00)</span>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="w-3.5 h-3.5 text-sky-600 shrink-0" strokeWidth={1.75} />
          ...
          <div className="space-y-3">
            ...
            <div className="p-3 rounded-xl bg-amber-50/80 border border-amber-200/60 text-[11px] text-amber-900 leading-relaxed">
        ...
        <div className="mt-8 border-t border-slate-100 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500">
          ...
          <div className="flex gap-4 mt-2 sm:mt-0">
            <Link href="/terms" className="hover:text-slate-800">Điều khoản sử dụng</Link>
            <Link href="/privacy" className="hover:text-slate-800">Chính sách bảo mật</Link>
          </div>
        </div>
      </div>
    </footer>
